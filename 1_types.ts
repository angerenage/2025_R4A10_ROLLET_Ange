...
class HttpRequest {
    ...
    constructor(method: HttpMethod, url: string, headers: { "Content-Type": string, [key: string]: string }) {
        this.method = method;
        this.url = url;
...
abstract class Guard {
    abstract canActivate(request: HttpRequest): boolean | Promise<boolean>;
}
...
abstract class Interceptor {
    abstract intercept(request: HttpRequest): void;
}
...
class HttpRespons {
    ...
    constructor(statusCode: number, headers: { "Content-Type": string, [key: string]: string }) {
